...
On line 14, the end pointer is simply decremented by 1. This does not correctly handle duplicates. The correct way is to skip over the duplicates using a while loop.
</bug_desc>
"""
class Solution:
